...
export const ChannelInfos: Record<string, ChannelInfo> = {
  ...
  palm: {
    ...
    description:
      ...
      "> 系统已适配当前官方 `generateContent` / `streamGenerateContent` 请求结构，并支持 `system_instruction`、Google Search、URL Context、Code Execution 与 function calling。 \n" +
  ...
  "gemini-enterprise-agent-platform": {
    ...
    description:
      ...
      "> 请求体沿用官方 Gemini `contents` / `systemInstruction` / `tools` / `generationConfig` 结构，并支持当前 Gemini 思考预算、URL Context、Google Search、Code Execution 与 function calling。 \n" +
